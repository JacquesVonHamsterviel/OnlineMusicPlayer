...
switch(getParam('types'))   // 根据请求的 Api，执行相应操作
{
    ...
    default:
        echo '<!doctype html><html><head><meta charset="utf-8"><title>API</title><style>* {font-family: microsoft yahei}</style></head><body> <h2>MusicPlayer (Version: 20221202)</h2><h3>Refer: https://github.com/mengkunsoft/MKOnlineMusicPlayer</h3><br>';
